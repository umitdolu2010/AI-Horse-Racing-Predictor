...
export const HorseIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 14.25a2.25 2.25 0 012.25-2.25h2.093a.75.75 0 00.51-.193l.396-.396a.563.563 0 01.796 0l.396.396a.75.75 0 00.51.193h2.093a2.25 2.25 0 012.25 2.25v2.093a.75.75 0 00.193.51l.396.396a.563.563 0 010 .796l-.396.396a.75.75 0 00-.193.51v2.093a2.25 2.25 0 01-2.25 2.25h-2.093a.75.75 0 00-.51.193l-.396.396a.563.563 0 01-.796 0l-.396-.396a.75.75 0 00-.51-.193H4.5a2.25 2.25 0 01-2.25-2.25V14.25z" />
     <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 9.813c.423-.423 1.05-.623 1.687-.623s1.264.2 1.687.623c.423.423.623 1.05.623 1.687s-.2 1.264-.623 1.687c-.423.423-1.05.623-1.687.623s-1.264-.2-1.687-.623c-.423-.423-.623-1.05-.623-1.687s.2-1.264.623-1.687z" />
  </svg>
);
...
export const RulesIcon = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const TrophyIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.625a1.125 1.125 0 011.125-1.125h2.25c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m-9-14.25v14.25A8.987 8.987 0 016 18a8.967 8.967 0 016 2.292" />
  </svg>
);